...
export const NEIGHBORHOODS: Neighborhood[] = [
  ...
  { name: 'Green Valley Ranch', lat: 39.7920, lng: -104.7680 },
  { name: 'Montbello',        lat: 39.7920, lng: -104.8200 },
  { name: 'Elyria-Swansea',   lat: 39.7763, lng: -104.9552 },
  { name: 'Elyria',           lat: 39.7780, lng: -104.9280 },
  ...
  { name: 'Brighton',         lat: 39.9853, lng: -104.8127 },

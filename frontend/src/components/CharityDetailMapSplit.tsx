  ...
  return (
    <section>
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start">
        ...
        {validLocs.length > 0 && (
          <div
            className="order-1 md:order-2 md:flex-1 w-full rounded-xl overflow-hidden h-[280px] md:h-[calc(100vh_-_120px)] md:sticky md:top-[88px]"
          >
            <MapGL
              ref={mapRef}
        ...
        {/* Card list — below map on mobile, scrollable left column on desktop */}
        <div
          className="order-2 md:order-1 w-full md:w-100 shrink-0 md:overflow-y-auto md:max-h-[calc(100vh_-_120px)]"
        >
          {cardList}
        </div>
      </div>

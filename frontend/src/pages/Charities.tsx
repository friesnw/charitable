    ...
    <div className="flex relative" style={{ height: "calc(100vh - 65px)" }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="relative flex-1">
              ...
              {locationEditing ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${selectedTags.length > 0 ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
          ...
          {/* Tag filters — desktop only (mobile uses filter overlay) */}
          <div className="hidden lg:block absolute left-0 right-0 z-10 p-3 top-0 pointer-events-none">
      ...
      {filterOverlayOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-white flex flex-col">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            <h2 className="font-heading font-bold text-lg text-gray-900">Causes</h2>
            <button
          ...
          <div className="flex-1 overflow-y-auto px-5 py-4">
            <div className="flex flex-wrap gap-3">
              {[...featuredTags, ...remainingTags].map((tag) => {
                const isActive = selectedTags.includes(tag);
                ...
                return (
                  ...
                  >
                    <span style={{ fontSize: 14 }}>{causeIcon([tag])}</span>
                    {tagLabels.get(tag) ?? tag}
                    {isActive && (
          ...
          <div className="px-5 py-4 border-t border-gray-100 flex items-center gap-3">
            ...
            <button
              onClick={() => setFilterOverlayOpen(false)}
              className="flex-1 py-3 rounded-full bg-gray-900 text-white text-sm font-semibold"
            >
              Show results
            </button>
          </div>

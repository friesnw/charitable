...
function toCharity(row: Record<string, unknown>) {
  return {
    ...
    coverPhotoFocalPoint: row.cover_photo_focal_point ?? null,
    ...
    approvedByCharity: row.approved_by_charity ?? false,
  ...
  Mutation: {
    updateCharity: async (_: unknown, args: Record<string, unknown>, context: Context) => {
      ...
      const fieldMap: Record<string, string> = {
        ...
        coverPhotoFocalPoint: 'cover_photo_focal_point',
        isReviewed: 'is_reviewed',
        approvedByCharity: 'approved_by_charity',
        impact: 'impact',
